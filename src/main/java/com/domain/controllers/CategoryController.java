...
public class CategoryController {
    ...
    public Iterable<Category> findByNama(@RequestBody SearchData searchData, @PathVariable("size") int size, @PathVariable("page") int page){
    ...
    public Iterable<Category> findByNama(@RequestBody SearchData searchData, @PathVariable("size") int size, @PathVariable("page") int page, @PathVariable("sort") String sort){
